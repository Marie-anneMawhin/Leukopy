...
def write():
    ...
    st.image("https://www.verywellhealth.com/thmb/nP6pLR72nAK3vVEhM1Wc35S32Ek=/1500x1000/filters:no_upscale():max_bytes(150000):strip_icc()/understanding-white-blood-cells-and-counts-2249217_final-0587074073ce4709b41e42a08db0f596.gif",
    width=450)
