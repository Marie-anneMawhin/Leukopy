...
def choose_model(image_file):
    mendeley = ["PLATELET", "BNE", "MO", "LY", "IG",
                "ERB", "EO", "BA", "SNE", "MY", "MMY", "PMY"]
...
def VGG16_SVM_6_C_SF(image_file):
    ...
    vgg16_path = Path(
        "./data/model/vgg16svm/MTL_MTL_Segment_8classes_Correspond_T")
    svm_path = Path(
        "./data/model/vgg16svm/svm_MTL_Segment_8classes_Correspond_T.pkl")
    ...
    # Feature extraction
    X_test_features = intermediate_layer_model.predict(
        preprocess_input(X_test_img))
    # SVM prediction
    ...
    if (classes[int(class_label)] == "IG") or (classes[int(class_label)] == "NEU"):
        ...
        vgg16_path = Path(
            "./data/model/vgg16svm/model_Transfer_Learning_segment5_Correspond")
        svm_path = Path(
            "./data/model/vgg16svm/svm_Transfer_Learning_segment5_Correspond.pkl")
...
def VGG16_SVM_6_C_AF(image_file):
    ...
    if (classes[int(class_label)] == "IG") or (classes[int(class_label)] == "NEU"):
        vgg16_path = Path(
            "./data/model/vgg16svm/model_Transfer_Learning_segment5")
        svm_path = Path(
            "./data/model/vgg16svm/svm_Transfer_Learning_segment5.pkl")
